...
const MentorRegister = () => {
  ...
  const verify = (e) => {
    ...
    //   };
      localStorage.clear();
      localStorage.setItem("Mentorfname",firstname);
      localStorage.setItem("Mentorlname",lastname);
      localStorage.setItem("Mentoruname",username);
      localStorage.setItem("Mentorpwd",password);
      localStorage.setItem("Mentorbranch",branch);
      localStorage.setItem("Mentoryear",year);
      window.location.href = "/mentorForm";
    }
  };
